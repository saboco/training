...
{
    public class EdmonsKarpFlowTests
    {
        [Fact]
        public void MaxFlowTest()
        {
            ...
            var solver = new EdmonsKarpFlowSolver(n, s, t);
